                        ...
                        <input type="hidden" name="id" value="{{$post->id}}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    ...
                                    <img src="{{asset($post->image)}} " class="float-right" alt="" width="100" height="100"   id="selected_photo">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    ...
                                    <input type="submit" id="shareButton" class="btn btn-primary px-4" value="Save&Change" disabled />
                                </div>
                            </div>
                        </div>
                    </form>
